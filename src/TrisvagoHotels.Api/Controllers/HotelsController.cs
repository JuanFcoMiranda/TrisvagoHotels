...
namespace TrisvagoHotels.Api.Controllers {
    ...
    public class HotelsController : ControllerBase {
        ...
        public async Task<IActionResult> PostAsync(Hotel hotel, [FromForm] IFormFile file) {
            if (hotel is null) {
                return BadRequest();
            }
        ...
        // PUT api/hotels/5
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, Hotel hotel, IFormFile file) {
